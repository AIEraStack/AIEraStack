...
export function LLMComparison({ scores, bestLLMId, selectedLLMId, onSelectLLM }: LLMComparisonProps) {
  ...
  return (
    <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
      <h2 className="text-lg font-semibold mb-4 text-white whitespace-nowrap">
        LLM Comparison
        ...
        {sortedLLMs.map((llm) => {
          ...
          return (
            <div
              ...
              className={`relative transition-all duration-200 ${isInteractive ? 'cursor-pointer hover:bg-slate-700/30 rounded-lg' : ''
                } ${isSelected
